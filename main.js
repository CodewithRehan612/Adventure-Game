...
console.log(chalk.bold.rgb(208, 208, 208)(`\n  \t\t <<<============================================>>>`));
console.log(chalk.bold.rgb(208, 208, 208)(`<<<==========>>>  ${chalk.bold.hex('#9999FF')('Welcome To \'Code With Rehan/Aslam\' - ADVENTURE==GAME')}  <<<===========>>>`));
console.log(chalk.bold.rgb(208, 208, 208)(`\t\t <<<============================================>>>\n`));
class Player {
    name;
    health;
    ...
    drinkEnergyDrink() {
        ...
        console.log(`Remaining drinks: ${chalk.bgYellowBright.bold(this.energy_drinks)}`);
    }
...
class Enemy {
    ...
    setHealthBasedOnType() {
        ...
        else if (this.name === "Laiba") {
            this.health = 70;
        }
        else if (this.name === "Aslam") {
            this.health = 100;
        }
    }
    attack() {
    ...
    showHealth(playerName, playerHealth, enemyHealth) {
